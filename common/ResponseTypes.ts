...
type AddCategoryResponse = CategoryProps
...
interface UpdateCategoryTransferResponse {
...
interface InsertCategoryTransferResponse {
  balances: CategoryBalanceProps[],
...
interface CategoryTreeBalanceProps {
  id: number,
  balance: number,
}
